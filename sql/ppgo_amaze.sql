...
-- ----------------------------
--  Table structure for `pp_value`
-- ----------------------------
DROP TABLE IF EXISTS `pp_value`;
CREATE TABLE `pp_value` (
  `id`          bigint unsigned   not null auto_increment,
  `code`        varchar(255)  NOT NULL  COMMENT '代码',
  `date`        varchar(255)  NOT NULL  COMMENT '日期',
  `tclose`      DECIMAL(9,4)  NOT NULL  COMMENT '收盘价',
  `high`        DECIMAL(9,4)  NOT NULL  COMMENT '最高价',
  `low`         DECIMAL(9,4)  NOT NULL  COMMENT '最低价',
  `topen`       DECIMAL(9,4)  NOT NULL  COMMENT '开盘价',
  `lclose`      DECIMAL(9,4)  NOT NULL  COMMENT '前收盘',
  `chg`         DECIMAL(8,4)  NOT NULL  COMMENT '涨跌额',
  `pchg`        DECIMAL(8,4)  NOT NULL  COMMENT '涨跌幅',
  `turnover`    DECIMAL(8,4)  NOT NULL  COMMENT '换手率',
  `voturnover`  bigint unsigned  NOT NULL  COMMENT '成交量',
  `vaturnover`  bigint unsigned  NOT NULL  COMMENT '成交金额',
  `tcap`        bigint unsigned  NOT NULL  COMMENT '总市值',
  `mcap`        bigint unsigned  NOT NULL  COMMENT '流通市值',
  PRIMARY KEY (id)
) ENGINE=InnoDB;
CREATE INDEX `pp_value_1` ON `pp_value` (`code`);
CREATE UNIQUE INDEX `pp_value_2` ON `pp_value` (`code`, `date`);
...
-- ----------------------------
BEGIN;
INSERT INTO `pp_uc_admin` VALUES ('1', 'admin', '超级管理员', '41b5e99335e4c9df0729f2e75ba399e8', '0', '13888888889', 'haodaquan2008@163.com', 'kmcB', '1507707108', '[', '1', '0', '0', '0', '1506128438'), ('4', 'ceshizhanghao', '测试姓名', 'fa3fb5825c2e64bc764e29245dd1ec7a', '2', '13988009988', '232@124.com', 'i8Nf', '0', '', '1', '1', '0', '1506047337', '1506128397');
COMMIT;
